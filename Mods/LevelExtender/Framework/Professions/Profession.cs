...
using System.Linq;
using LevelExtender.Framework.Professions.Registration;
...
namespace LevelExtender.Framework.Professions
{
    ...
    public abstract partial class Profession
    {
        ...
        *********/
        ...
        /// <summary>Adds all professions that should exist for the player based upon their prestige data.</summary>
        public static void AddMissingProfessions()
        {
            ...
            foreach (var profession in Skill.AllSkills.SelectMany(x => x.Professions))
            {
